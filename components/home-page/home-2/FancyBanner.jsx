...
const FancyBanner = () => {
  const bannerData = [
    {
      title: "Prioritas",
      mainTitle: "Mengapa harus menggunakan layanan Kami?",
      description:
        "Kami selalu melakukan riset untuk menganalisis pasar guna menciptakan website yang sesuai untuk bisnis atau portofolio Anda.",
      buttonLabel: "Click here to learn more",
      illustration: "/images/assets/target-1.png",
    ...
    {
      title: "Motivasi",
      mainTitle: "Kepuasan Pelanggan No.1",
      description:
        "Prioritas kami adalah menyediakan layanan terbaik bagi Anda yang ingin mengembangkan bisnis atau portofolio.",
      buttonLabel: "",
      illustration: "/images/assets/trusted.png",
      illustrationAlt: "illustration",
