          ...
          >
            <div className="title-style-one mb-30">
              <h2 className="main-title fw-500 text-white m0">
                Butuh jasa desain profesional?
              </h2>
            </div>
            <p className="fs-20 text-white opacity-75 mb-50 md-mb-30">
              Famous desain adalah bagian dari Generasi Digital Kreatif Indonesia yang memiliki tim desainer terbaik.
            </p>
            <Link
              href="/about"
              className="btn-twentyFive fw-500 tran3s"
            >
              Mengenai kami <i className="bi bi-arrow-right ms-2" />
            </Link>
          </div>
          {/* End .col */}
