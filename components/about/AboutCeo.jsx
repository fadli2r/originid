...
const AboutCeo = () => {
  const aboutData = {
    title: {
      ...
      mainTitle: (
        <>
          Originfamous.id <span>Bantu Bisnismu</span> Meluas.
        </>
      ),
    },
    content: {
      sectionTitle: "Kenalan yuk?",
      description:
        "awal mula dari keluh kesah seorang pengusaha muda yang melihat banyak sekali bisnis yang kurang proper dalam membangun portofolio bisnisnya.",
    },
    rating: {
      text: "Avg 4.8 rating makes us world best agency in Indonesia.",
      starsCount: 5,
    },
  };
